...
public interface aaIDAO<T> {
    ...
    Integer getCountReg()        throws aaAppException;
    Integer getMinReg(String tableCelName) throws aaAppException;
    Integer getMaxReg(String tableCelName) throws aaAppException;
}
