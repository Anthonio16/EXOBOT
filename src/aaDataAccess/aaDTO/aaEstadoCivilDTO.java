...
public class aaEstadoCivilDTO {
    ...
    public aaEstadoCivilDTO(){}

    public aaEstadoCivilDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion, String estado,
