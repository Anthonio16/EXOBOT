...
import aaInfrastructure.Tools.aaCMD;
...
public abstract class aaAppConfig {
    ...
    static {
        try (InputStream appProperties = new FileInputStream(APP_PROPERTIES)) {
            ...
            aaCMD.printlnError("ERROR al cargar ❱❱ " + e.getMessage());
        }
    }
    ...
    static String getProperty(String key) {
        ...
        aaCMD.println("AppConfig ❱❱ "+ APP_PROPERTIES +"." + key + " : "+ path);
        if(path != null)
            return  path;
        else
            aaCMD.printlnError("ERROR ❱❱ " + APP_PROPERTIES +"." + key + " : "+ path);
        return null;
    }
    ...
    static URL getAppResource(String key) {
        ...
        if(path != null)
            return  aaAppConfig.class.getResource(path);
        else
            aaCMD.printlnError("ERROR ❱❱ getAppResource : " + APP_PROPERTIES +"." + key + " : "+ path);
        return null;
    }
